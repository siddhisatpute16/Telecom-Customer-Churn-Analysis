...
![Summary Page Screenshot](Dashboard_Screenshots/Summary_page.png)


### 📉 **Churn Reason Analysis (Tooltip Page)**

![Churn Reason Page](Dashboard_Screenshots/Churn_Reason.png)
...
- `Dashboard_Preview_Video.mp4` - small walkthrough
